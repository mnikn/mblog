...
export const ARTICLES: Article[] = [
  {title: 'good', content: CONTENT1, tags: TAGS, insertDate: new Date(2016, 5, 4)},
  {title: 'nice', content: CONTENT2, tags: TAGS, insertDate: new Date(2016, 3, 4)},
  {title: 'well', content: CONTENT3, tags: TAGS, insertDate: new Date(2017, 4, 4)},
  {title: 'fuck', content: CONTENT4, tags: TAGS, insertDate: new Date(2017, 2, 4)}
];
